...
export default function ImageSlider({ images, intervalMs = 2000, className = '', innerClassName = 'aspect-[4/3] w-full h-full', imageClassName = 'h-full w-full object-cover', showTitle = true, showDots = true }) {
