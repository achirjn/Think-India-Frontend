              ...
              {slides.length > 0 ? (
                <>
                  <img
                    ...
                    className="w-full h-[50vh] sm:h-[60vh] md:h-[68vh] object-cover"
                  />
                  {slides.length > 1 && (
                    <>
                      <button
                ...
                <div className="w-full h-[42vh] sm:h-[50vh] md:h-[58vh] bg-gray-100 flex items-center justify-center text-gray-500">
                  No images available
                </div>
              )}
            </div>
