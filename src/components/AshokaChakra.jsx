...
export default function AshokaChakra({ className = '', size = 520, opacity = 0.14, rotate = 0 }) {
  ...
  return (
    ...
    >
      <circle cx={radius} cy={radius} r={outerRadius} fill="none" stroke="currentColor" strokeWidth="10" />
      <circle cx={radius} cy={radius} r={innerRadius} fill="none" stroke="currentColor" strokeWidth="8" />
      {lines}
    </motion.svg>
  )
}
